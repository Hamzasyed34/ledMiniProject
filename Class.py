...
if userInputReason == 'yes':
    reasonForCreatingTheAI("**Reason why John created Timothy:**")
...
def userChoiceGovernmentData():
    ...
    if helpOrNot == "yes":
            ...
            if reportOrNot == "no":
                ...
                print("\nAfter John’s steam and Timothy explanation to both countries they stop the war and catch the terrorists responsible. However, there were millions of casualties therefore government banes any inventions like Timothy and decides to destroy Timothy.")
                print("\nso later they also decided to create stricter chip called E.C. which would only allow Timothy to talk when talked to which would limit the amount of data it can access. to prevent this from happening again.")
                print(endingFunction())
